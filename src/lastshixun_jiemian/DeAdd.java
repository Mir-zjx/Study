...
public class DeAdd extends JFrame{
	DeAdd(){
		setTitle("添加餐台");
		setSize(330, 500);
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (e.getSource() == bt1) {
					if (tx1.getText().equals("")){ 
						...
						JOptionPane.showMessageDialog(null, "餐台编号不能为空"); 
				...
				Desk desk = new Desk(Integer.parseInt(tx1.getText()),
						tx2.getText(),Integer.parseInt(tx3.getText()),tx4.getText());
				DeskDAOImpl add = new DeskDAOImpl();
				add.add(desk);
